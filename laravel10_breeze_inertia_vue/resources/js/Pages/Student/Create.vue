    ...
    <div class="container">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" class="form-control" v-model="stu.language" value="bangla"> Bangla <br>
                <input type="checkbox" class="form-control" v-model="stu.language" value="english"> English <br>
                <input type="checkbox" class="form-control" v-model="stu.language" value="arabic"> Arabic <br>
                <input type="checkbox" class="form-control" v-model="stu.language" value="urdu"> Urdu
