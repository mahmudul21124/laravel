...
<template>
  ...
  <div class="counter-area bg-gray">
    <div class="container">
      <div
        class="counter-area-inner pd-top-110 pd-bottom-120"
  ...
  <div class="events-area pd-top-110 pd-bottom-120">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <ul
            class="single-blog-list-wrap style-white"
            ...
            <li>
              <div class="media single-blog-list-inner style-white">
                ...
                <div class="media-body details">
                  ...
                  <h5>
                    <a href="blog-details.html">Clone sit amet, consec tetur elit</a>
                  </h5>
                </div>
              </div>
            </li>
            <li>
              <div class="media single-blog-list-inner">
                ...
                <div class="media-body details">
                  ...
                  <h5>
                    <a href="blog-details.html">Maecenas interdum lorem eleifend</a>
                  </h5>
                </div>
              </div>
            </li>
            <li>
              <div class="media single-blog-list-inner">
                ...
                <div class="media-body details">
                  ...
                  <h5>
                    <a href="blog-details.html">Nunc scelerisque tincidunt elit. </a>
                  </h5>
                </div>
              </div>
            </li>
