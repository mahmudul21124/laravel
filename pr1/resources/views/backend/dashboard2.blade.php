                                        ...
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                <input type="text" placeholder="Title*"
                                                    class="form-control bg-white text-muted " required>
                                            </div>
                    ...
                    <div class="col-xl-12 col-sm-6 col-xxl-6">
                        <div class="card widget-active-class">
                            <div class="card-body">
                                ...
                                <div class="card mb-3">
                                    <div
                                        class="card-body align-items-center d-flex justify-content-between p-4">
                                        <h5 class="mb-0 item">Astronomy 101</h5>
                                        <div class="item d-flex align-items-center">
                                            <span class="total-students text-pale-sky"><i
                                                    class="fa fa-users mr-3"></i>28</span>
                                            <span class="add-class ml-4 text-warning c-pointer"><i
                                ...
                                <div class="card mb-3">
                                    <div
                                        ...
                                        <div class="item d-flex align-items-center">
                                            <span class="total-students text-pale-sky"><i
                                                    class="fa fa-users mr-3"></i>27</span>
                                            <span class="add-class ml-4 text-warning c-pointer"><i
                                                    class="fa fa-plus-circle"></i></span>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="stat-widget-search-2">
                            <div class="form-group border">
                                <input type="search" name="enrollment" placeholder="Search" id="enrollment"
                                    class="form-control">
