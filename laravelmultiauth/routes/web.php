...
Route::middleware('guest:admin')->prefix('admin')->group(function () {
    ...
    Route::post('register', [App\Http\Controllers\Auth\Admin\RegisterController::class, 'checkUser']);
});
...
Route::middleware('guest:teacher')->prefix('teacher')->group(function () {
    ...
    Route::get('register', [App\Http\Controllers\Auth\Teacher\RegisterController::class, 'create'])->name('teacher.register');
    Route::post('register', [App\Http\Controllers\Auth\Teacher\RegisterController::class, 'checkUser']);
});
